...
save(result.benel, file = paste("./simulation/sim_1_normal_n50_BENEL_parameter.Rdata", sep=""))
### n=100
result.benel=parLapply(cl, 1:n.sim, BENELSIM, "normal_n100")
save(result.benel, file = paste("./simulation/sim_1_normal_n100_BENEL_parameter.Rdata", sep=""))
### n=200
result.benel=parLapply(cl, 1:n.sim, BENELSIM, "normal_n200")
save(result.benel, file = paste("./simulation/sim_1_normal_n200_BENEL_parameter.Rdata", sep=""))

## normal2
### n=50
result.benel=parLapply(cl, 1:n.sim, BENELSIM, "normal2_n50")
save(result.benel, file = paste("./simulation/sim_1_normal2_n50_BENEL_parameter.Rdata", sep=""))
### n=100
result.benel=parLapply(cl, 1:n.sim, BENELSIM, "normal2_n100")
save(result.benel, file = paste("./simulation/sim_1_normal2_n100_BENEL_parameter.Rdata", sep=""))
### n=200
result.benel=parLapply(cl, 1:n.sim, BENELSIM, "normal2_n200")
save(result.benel, file = paste("./simulation/sim_1_normal2_n200_BENEL_parameter.Rdata", sep=""))

## skew t
### n=50
result.benel=parLapply(cl, 1:n.sim, BENELSIM, "st_n50")
save(result.benel, file = paste("./simulation/sim_1_st_n50_BENEL_parameter.Rdata", sep=""))
### n=100
result.benel=parLapply(cl, 1:n.sim, BENELSIM, "st_n100")
save(result.benel, file = paste("./simulation/sim_1_st_n100_BENEL_parameter.Rdata", sep=""))
### n=200
result.benel=parLapply(cl, 1:n.sim, BENELSIM, "st_n200")
save(result.benel, file = paste("./simulation/sim_1_st_n200_BENEL_parameter.Rdata", sep=""))

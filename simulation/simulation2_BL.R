...
save(result.bl, file = paste("./simulation/sim_2_normal_n100_BL.Rdata", sep=""))
### n=200
result.bl=parLapply(cl, 1:n.sim, BLSIM, "normal_n200")
save(result.bl, file = paste("./simulation/sim_2_normal_n200_BL.Rdata", sep=""))

## t
### n=100
result.bl=parLapply(cl, 1:n.sim, BLSIM, "t_n100")
save(result.bl, file = paste("./simulation/sim_2_t_n100_BL.Rdata", sep=""))
### n=200
result.bl=parLapply(cl, 1:n.sim, BLSIM, "t_n200")
save(result.bl, file = paste("./simulation/sim_2_t_n200_BL.Rdata", sep=""))

## skew t
### n=100
result.bl=parLapply(cl, 1:n.sim, BLSIM, "st_n100")
save(result.bl, file = paste("./simulation/sim_2_st_n100_BL.Rdata", sep=""))
### n=200
result.bl=parLapply(cl, 1:n.sim, BLSIM, "st_n200")
save(result.bl, file = paste("./simulation/sim_2_st_n200_BL.Rdata", sep=""))

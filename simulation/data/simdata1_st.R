...
datagen = function(n.train,n.test,n.sim){
  ...
  for (sim in 1:n.sim) {
    ...
    # generate y
    y.train      = x.train %*% beta.true + sigma.true * rsstd(n.train,mean=0,sd=3,nu=30,xi=1+0.5)
    y.test       = x.test %*% beta.true + sigma.true * rsstd(n.test,mean=0,sd=3,nu=30,xi=1+0.5)
...
save(simdata, file = "./simulation/data/sim_1_st_n50.Rdata")
## n=100
n.train  = 100
simdata=datagen(n.train,n.test,n.sim)
save(simdata, file = "./simulation/data/sim_1_st_n100.Rdata")
## n=200
n.train  = 200
simdata=datagen(n.train,n.test,n.sim)
save(simdata, file = "./simulation/data/sim_1_st_n200.Rdata")

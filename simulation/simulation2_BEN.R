...
save(result.ben, file = paste("./simulation/sim_2_normal_n100_BEN.Rdata", sep=""))
### n=200
result.ben=parLapply(cl, 1:n.sim, BENSIM, "normal_n200")
save(result.ben, file = paste("./simulation/sim_2_normal_n200_BEN.Rdata", sep=""))

## t
### n=100
result.ben=parLapply(cl, 1:n.sim, BENSIM, "t_n100")
save(result.ben, file = paste("./simulation/sim_2_t_n100_BEN.Rdata", sep=""))
### n=200
result.ben=parLapply(cl, 1:n.sim, BENSIM, "t_n200")
save(result.ben, file = paste("./simulation/sim_2_t_n200_BEN.Rdata", sep=""))

## skew t
### n=100
result.ben=parLapply(cl, 1:n.sim, BENSIM, "st_n100")
save(result.ben, file = paste("./simulation/sim_2_st_n100_BEN.Rdata", sep=""))
### n=200
result.ben=parLapply(cl, 1:n.sim, BENSIM, "st_n200")
save(result.ben, file = paste("./simulation/sim_2_st_n200_BEN.Rdata", sep=""))
